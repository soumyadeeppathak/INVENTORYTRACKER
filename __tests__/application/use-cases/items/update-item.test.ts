...
describe('UpdateItemUseCase', () => {
  ...
  beforeEach(() => {
    ...
    useCase = new UpdateItemUseCase(mockItemRepository, mockLocationRepository, mockGroupRepository)
  })

  it('should update item name and emoji', async () => {
  ...
  it('should allow updating to same name', async () => {
    ...
    vi.mocked(mockLocationRepository.findById).mockResolvedValue(location)
    vi.mocked(mockGroupRepository.isMember).mockResolvedValue(true)
    vi.mocked(mockItemRepository.findByLocationAndName).mockResolvedValue(item)
